...
//
        ...
        mCamera.takePicture(null, null, new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                String photoFile = "Picture_" + System.currentTimeMillis() + ".jpeg";
                ...
                try
                {
                    ...
                    fos.write(data);
                    fos.close();
                    Log.i(TAG, "New Image saved:" + photoFile);
                } catch (Exception error) {
                    Log.d(TAG, "File" + photoFile + "not saved: " + error.getMessage());
                ...
                if (callback != null) {
                    if (nowAngle == 90 || nowAngle == 270) {
                        callback.captureResult(imageFilePath,bitmap, true);
                    } else {
                        callback.captureResult(imageFilePath,bitmap, false);
                    }
                }
            }
        });
...
//        }
    ...
    public interface TakePictureCallback {
        void captureResult(String imagePath,Bitmap bitmap, boolean isVertical);
    }
