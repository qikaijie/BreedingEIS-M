package net.cnbec.catering.ui.base.print.ReceiptPrinter;
...
import net.cnbec.catering.ui.base.print.LinkActivity;
...
public class R80Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void printSample(){
        if (LinkActivity.ISCONNECT){
            LinkActivity.myBinder.WriteSendData(new TaskCallback() {
                @Override
        ...
        if (LinkActivity.ISCONNECT){
            LinkActivity.myBinder.WriteSendData(new TaskCallback() {
                ...
                public List<byte[]> processDataBeforeSend() {
                    ...
                    //选择对齐方式
                    list.add(DataForSendToPrinterPos80.selectAlignment(1));
                    list.add(DataForSendToPrinterPos80.printQRcode(3,48,"www.printer.net"));
                    list.add(DataForSendToPrinterPos80.printAndFeedLine());
                    return list;
                }
            });
...
//        final Bitmap bitmap1 = BitmapFactory.decodeResource(getResources(), R.drawable.test);
        final Bitmap bitmap1 =  BitmapProcess.compressBmpByYourWidth
                (BitmapFactory.decodeResource(getResources(), R.drawable.test2),576);
