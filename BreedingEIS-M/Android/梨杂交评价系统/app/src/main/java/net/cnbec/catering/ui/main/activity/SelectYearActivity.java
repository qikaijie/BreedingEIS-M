...
import net.cnbec.catering.ui.common.dialog.pop.SelectSpeciesDialogForBottomFragment;
...
public class SelectYearActivity extends BaseActivity<SelectYearContract.View, SelectYearContract.Presenter> implements SelectYearContract.View {
    ...
    public static void startActivity(Context context,Activity activity,Integer businessType,Integer selectYear,Object selectData) {
        Intent intent = new Intent(context, SelectYearActivity.class);
    ...
    protected void initListener() {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(SelectYearActivity.this, LinearLayoutManager.VERTICAL, false));
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            {
                //选择时间
                OptionsPickerView pvOptions = new OptionsPickerBuilder(SelectYearActivity.this, new OnOptionsSelectListener() {
                    @Override
