...
@interface PJHistoryViewController ()<CMPageTitleViewDelegate>
...
@implementation PJHistoryViewController
...
- (void)viewDidLoad {
    ...
    [self.childControllers addObject:[[PJHistoryDetailsViewController alloc] initGroupIndex:0 andPlantId:(int)self.plantId blockValue:self.copyValueBlock]];
    [self.childControllers addObject:[[PJHistoryDetailsViewController alloc] initGroupIndex:1 andPlantId:(int)self.plantId blockValue:self.copyValueBlock]];
    [self.childControllers addObject:[[PJHistoryDetailsViewController alloc] initGroupIndex:2 andPlantId:(int)self.plantId blockValue:self.copyValueBlock]];
