...
class WMCameraControl: UIView {
    ...
    func setupCameraButton() {
        ...
        gradientLayer.colors = [#colorLiteral(red: 0.3058823529, green: 0.662745098, blue: 0.3921568627, alpha: 1).cgColor, #colorLiteral(red: 0.3058823529, green: 0.662745098, blue: 0.3921568627, alpha: 1).cgColor]
