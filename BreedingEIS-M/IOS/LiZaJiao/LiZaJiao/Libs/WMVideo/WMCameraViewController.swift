...
class WMCameraViewController: UIViewController {
    ...
    typealias urlBlock = (String , String) -> Void
    var fileUrlBlock:urlBlock?
...
extension WMCameraViewController: WMCameraControlDelegate {
    ...
    func cameraControlDidComplete() {
        dismiss(animated: true) {
            if ((self.fileUrlBlock) != nil){
                self.fileUrlBlock!(self.url!, self.type! == WMCameraType.image ? "image" : "video")
            }
