...
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView *)pickerView
{
    switch (self.datePickerStyle) {
        case DateStyleShowYearMonthDayHourMinute:
            [self addLabelWithName:@[NSLocalizedString(@"year", @""),NSLocalizedString(@"month", @""),NSLocalizedString(@"day", @""),NSLocalizedString(@"hont", @""),NSLocalizedString(@"min", @"")]];
            return 5;
        case DateStyleShowMonthDayHourMinute:
            [self addLabelWithName:@[NSLocalizedString(@"month", @""),NSLocalizedString(@"day", @""),NSLocalizedString(@"hont", @""),NSLocalizedString(@"min", @"")]];
            return 4;
        case DateStyleShowYearMonthDay:
            [self addLabelWithName:@[NSLocalizedString(@"year", @""),NSLocalizedString(@"month", @""),NSLocalizedString(@"day", @"")]];
            return 3;
        case DateStyleShowYearMonth:
            [self addLabelWithName:@[NSLocalizedString(@"year", @""),NSLocalizedString(@"month", @"")]];
            return 2;
        case DateStyleShowMonthDay:
            [self addLabelWithName:@[NSLocalizedString(@"month", @""),NSLocalizedString(@"day", @"")]];
            return 2;
        case DateStyleShowHourMinute:
            [self addLabelWithName:@[NSLocalizedString(@"hont", @""),NSLocalizedString(@"min", @"")]];
            return 2;
        case DateStyleShowYear:
            [self addLabelWithName:@[NSLocalizedString(@"year", @"")]];
            return 1;
        case DateStyleShowMonth:
            [self addLabelWithName:@[NSLocalizedString(@"month", @"")]];
            return 1;
        case DateStyleShowDayHourMinute:
            [self addLabelWithName:@[NSLocalizedString(@"day", @""),NSLocalizedString(@"hont", @""),NSLocalizedString(@"min", @"")]];
            return 3;
        default:
            return 0;
    }
