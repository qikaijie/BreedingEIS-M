...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [Bugly startWithAppId:@"0794992092"];
    
    //初始化应用语言
    [[ChangeLanguage sharedInstance] initLanguage];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(disconnectBle:) name:ConnectBleFailNote object:nil];
...
- (void)disconnectBle:(NSNotification *)text{
