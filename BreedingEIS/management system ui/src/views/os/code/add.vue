    ...
    <el-row>
      <el-form ref="form" :model="form" label-width="120px" :rules="rules">
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item :label="$t('menu.breeding.tiaomaku.label.hybrid')" prop="hybridId">
              <el-input v-model="form.hybridName" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
...
<script>
import { listPlant, addPlant } from "@/api/os/plant";
export default {
  props:["hybridId", "sowingCode", "hybridName", "allPlantList"],
  computed: {
      calcWidth:function () {
  ...
  data() {
    ...
    return {
        ...
        form: {
            ...
            hybridName: this.hybridName,
            fieldNumber: this.sowingCode,
            tableData: [],
        },
        // 表单校验
        rules: {
