package com.liuxn.yuzhong.project.system.controller;
...
import com.liuxn.yuzhong.project.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
     ...
     */
    @ApiOperation("查询用户列表")
    @ApiImplicitParam(name="查询条件", type="user", dataType="SysUser", dataTypeClass=SysUser.class)
    ...
    @ApiImplicitParam(name="用户id", type="userId", dataType="long", dataTypeClass=Long.class)
     ...
     */
    @ApiOperation("添加用户信息")
    @ApiImplicitParam(name="用户信息", type="user", dataType="SysUser", dataTypeClass=SysUser.class)
